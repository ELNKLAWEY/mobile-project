...
class AllNewArrivalsScreen extends ConsumerStatefulWidget {
  const AllNewArrivalsScreen({super.key});

  @override
  ConsumerState<AllNewArrivalsScreen> createState() =>
      _AllNewArrivalsScreenState();
}

class _AllNewArrivalsScreenState extends ConsumerState<AllNewArrivalsScreen> {
              ...
              child: productsAsync.when(
                data: (products) {
                  ...
                  return RefreshIndicator(
                    onRefresh: () async {
                      // We must return a Future, so await the provider
                      await ref.refresh(newArrivalsProvider.future);
                    },
                    child: Builder(
                      // Use Builder or extract method to keep code clean and sorted
                      builder: (context) {
